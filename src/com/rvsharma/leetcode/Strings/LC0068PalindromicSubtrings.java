 ...
 * Otherwise we calculate the size of each space evenly and if there is a remainder we distribute
 * an extra space until it is gone.
 */
public class LC0068PalindromicSubtrings {
