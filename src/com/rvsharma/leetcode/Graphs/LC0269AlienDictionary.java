...
public class LC0269AlienDictionary {
    ...
    public String alienOrder(String[] words) {
        ...
        for (int i = 0; i < words.length - 1; i++) {
            ...
            for (int j = 0; j < minLength; j++) {
                ...
                // for the input such as CurrWord -> nextWord == "abcd"->"ab", input is invalid and "" must be returned
                if(j == nextWord.length() - 1 && curWord.length() > nextWord.length()){
                    return "";
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        LC0269AlienDictionary sol = new LC0269AlienDictionary();
        String res = sol.alienOrder(words);
        System.out.println("Order is " + res);
    }
}
