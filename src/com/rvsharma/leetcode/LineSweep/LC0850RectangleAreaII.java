package com.rvsharma.leetcode.LineSweep;

import java.util.*;

class LC0850RectangleAreaII {
    static class Point {
        int x, y, val;
    ...
    public static void main(String[] args) {
        int[][] map = new int[][]{{0,0,2,2}, {1,0,2,3}, {1,0,3,1}};
        LC0850RectangleAreaII sol = new LC0850RectangleAreaII();
        int area = sol.rectangleArea(map);
